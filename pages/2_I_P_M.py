...
st.title('Indikator Pembangunan Manusia :blue[Kabupaten Pangandaran]')
...
with st.container(border=True):
    st.success('Tren IPM Kabupaten Pangandaran')
...
with kol1a:
    with st.container(border=True):
        st.info('Tren Pengeluaran Perkapita Disesuaikan (000 Rp) Kabupaten Pangandaran')
...
with kol1b:
    with st.container(border=True):
        st.warning('Pertumbuhan IPM Kabupaten Pangandaran (%)')
...
with kol2a:
    with st.container(border=True):
        st.warning('Tren Lama Sekolah di Kabupaten Pangandaran')
...
with kol2b:
    with st.container(border=True):
        st.info('Tren Usia Harapan Hidup (UHH) di Kabupaten Pangandaran')
...
with st.expander('Lihat Tabel Lengkap'):
    st.success('Indikator Pembangunan Manusia Kabupaten Pangandaran')
